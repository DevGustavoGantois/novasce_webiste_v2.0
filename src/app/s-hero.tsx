...
export function HomeHero() {
    return (
        <section className="bg-green-gradient lg:mt-20" id="Home">
                ...
                <div className="flex justify-center items-center flex-col">
                   ...
                   <h1 className="text-deep_blue text-4xl md:text-5xl lg:text-6xl font-bold text-center" data-aos="flip-up">Lorem ipsum dolor sit amet, <br /> consectetur adipiscing elit.</h1>
                   </div>
